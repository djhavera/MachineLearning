...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning = True, epsilon = 1.0, alpha = 0.5, decay_rate=0.005):
        ...
        self.valid_actions = self.env.valid_actions  # The set of valid actions , epsilon=1.0, alpha=0.5
    ...
    def build_state(self):
        ...
        #state = (right, left, light, oncoming, waypoint)
    ...
    def get_maxQ(self, state):
        ...
        action_with_maxQ = max(self.Q[state], key=self.Q[state].get)
        maxQ = self.Q[state][action_with_maxQ]
    ...
    def choose_action(self, state):
        ...
        action_options = self.valid_actions
        
        if self.learning:
            if random.random() < self.epsilon:
                action = action_options[random.randint(0, 3)]
            else:
...
def run():
    ...
    #num_dummies = 100 #- discrete number of dummy agents in the environment, default is 100
    #grid_size = (8, 6) #- discrete number of intersections (columns, rows), default is (8, 6)
    ...
    #epsilon = 0.0 #- continuous value for the exploration factor, default is 1
    #alpha = 0.0 #   - continuous value for the learning rate, default is 0.5
